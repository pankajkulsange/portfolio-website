...
const Contact = ({ 
  email = "pankaj.kulsange@gmail.com",
  phone = "+91-XXXXXXXXXX",
  location = "Pune, India",
  socials = [
    {
      platform: "LinkedIn",
      url: "https://linkedin.com/in/pankaj-kulsange",
      icon: (
    ...
    {
      platform: "GitHub",
      url: "https://github.com/pankaj-kulsange",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      platform: "Twitter",
      url: "https://twitter.com/pankaj-kulsange",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div variants={itemVariants} className="space-y-6 mb-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href={`tel:${phone}`} className="text-gray-300 hover:text-purple-primary transition-colors duration-300 font-inter">
                    {phone}
                  </a>
                </div>
              </div>
